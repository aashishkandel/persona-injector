...
import { composeForMultiFile, composeForSingleFile } from "./composer.js";
import {
	AGY_RULES_DIR,
	CLAUDE_RULES_DIR,
...
import { fileExists, readFileSafe, writeFileSafe } from "./fs-utils.js";
...
async function injectMultiFileTarget(
	...
	const results: InjectionResult[] = [];
	const { files } = await composeForMultiFile(
		personaNames,
		targetId,
		extension,
	);
